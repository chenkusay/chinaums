...
import com.chinaums.gen.entity.ColumnEntity;
import com.chinaums.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
			List<Map<String, String>> columns, ZipOutputStream zip,String packageName){
		//配置信息
